...
Source0  : https://download.kde.org/stable/plasma/6.0.0/oxygen-sounds-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/oxygen-sounds-6.0.0.tar.xz.sig
...
%prep
%setup -q -n oxygen-sounds-6.0.0
cd %{_builddir}/oxygen-sounds-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709333626
mkdir -p clr-build
pushd clr-build
