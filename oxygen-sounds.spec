...
Source0  : https://download.kde.org/stable/plasma/6.2.5/oxygen-sounds-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/oxygen-sounds-6.2.5.tar.xz.sig
...
%setup -q -n oxygen-sounds-6.2.5
cd %{_builddir}/oxygen-sounds-6.2.5
pushd ..
cp -a oxygen-sounds-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736192578
mkdir -p clr-build
pushd clr-build
